                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      AuthButton(title: "Sign Up",isloading: state.isloading, ontap: () {
                        FocusManager.instance.primaryFocus?.unfocus();
                   if(!state.isloading){     if (_formKey.currentState!.validate()) {
                     context.read<AuthBloc>().add(Signupwithemail(
                      ...
                      Gap(20),
                      Center(
                        child: RichTextButton(text: "Already Have an Acount",actionText: "Login",onTap: () {
                          NavigationService.goto(LoginScreen());
                        },),
                      )
